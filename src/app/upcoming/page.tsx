...
import { BellRing, Bookmark, ArrowUpRight, Calendar, List } from "lucide-react"
...
export default function ContestTable() {
  ...
  if (!loading)
    return (
      <div className="p-4">
        <AnimatePresence>
          {showAddReminder && viewMode === "table" && (
            <AddReminder setShowAddReminder={setShowAddReminder} contest={selectedContest || ({} as Contest)} />
          )}
          {showAddReminder && viewMode === "calendar" && (
            <AddReminderAndBookmark contest={selectedContest || ({} as Contest)} setShowAddReminder={setShowAddReminder} onToggleBookmark={toggleBookmark} bookmarks={bookmarks} />
          )}
        </AnimatePresence>
